...
class QuadInputPopup(wx.Frame):
    ...
    def onOKClick(self, event):
        ...
        if a != 0:
            self.parent.canvas.drawings.append(self.quadraticDrawing(a, b, c))
        else:
            self.parent.canvas.drawings.append(self.lineDrawing(b, c))
        self.Show(False)
        self.parent.buttons[1] = True
